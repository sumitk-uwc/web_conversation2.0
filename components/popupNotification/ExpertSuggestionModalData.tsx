...
interface ExpertSuggestionModalDataProps {
...
const ExpertSuggestionModalData: React.FC<ExpertSuggestionModalDataProps> = ({
  modalVisible,
  setModalVisible,
  data,
}) => {
...
export default ExpertSuggestionModalData;
